...
const Program = ({ service }) => (
  ...
  >
    <Col
      style={{ position: 'relative', padding: '0px', marginBottom: '8px' }}
      xs={12}
    >
      <div style={{ position: 'relative' }}>
        <ProductImage fluid={service.service__image.childImageSharp.fluid} />
        {service.badge && (
    ...
    <Col xs={12} style={{ zIndex: 3, padding: '0px' }}>
      ...
      <Row>
        <InfoItem size={24} textColor='black' copy={service.length}>
          {' '}
          <StyledCalendar />{' '}
        </InfoItem>
        <InfoItem size={24} textColor='black' copy={service.env}>
          {' '}
          <StyledHome />{' '}
        </InfoItem>
        <InfoItem size={24} textColor='black' copy={service.skill}>
          {' '}
          <StyledSkill />{' '}
        </InfoItem>
      </Row>
      <Body2 mt={0} color={'mdGrey'}>
        {' '}
        {service.desc}
      </Body2>
      <Button
