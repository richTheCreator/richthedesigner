module.exports = {
  ...
  title: 'Elevated Trading LLC', // Navigation and Site Title
  description: 'Better wholesale hemp.',
  url: 'https://elevated-trading.netlify.app/', // Domain of your site. No trailing slash!
